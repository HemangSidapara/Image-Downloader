...
import 'package:image_downloader/app/Constants/api_urls.dart';
import 'package:image_downloader/app/Constants/app_constance.dart';
import 'package:image_downloader/app/Constants/get_storage.dart';
import 'package:image_downloader/app/utils/progress_dialog.dart';
import 'package:image_downloader/app/utils/utils.dart';
...
class ApiBaseHelper {
  ...
  static dynamic requestInterceptor(RequestOptions options, RequestInterceptorHandler handler) async {
    ...
    options.headers.addAll({"Authorization": "Bearer ${getData(AppConstance.authorizationToken)}", "language": getData(AppConstance.languageCode)});
